---
layout: model
title: Legal Representations And Warranties Clause Binary Classifier (Bert Sentence Embeddings)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_representations_and_warranties_bert_en_1.0.0_3.0_1671227640337.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_representations_and_warranties_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_representations_and_warranties_bert|
