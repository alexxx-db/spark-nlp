...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_confidential_information_bert_en_1.0.0_3.0_1671227637230.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_confidential_information_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_confidential_information_bert|
