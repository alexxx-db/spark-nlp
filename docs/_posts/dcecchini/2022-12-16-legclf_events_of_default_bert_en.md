...
date: 2022-12-16
tags: [en, legal, clauses, classification, licensed, bert, events, of, default, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_events_of_default_bert_en_1.0.0_3.0_1671227634088.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
{:.table-model}
|---|---|
|Model Name:|legclf_events_of_default_bert|
