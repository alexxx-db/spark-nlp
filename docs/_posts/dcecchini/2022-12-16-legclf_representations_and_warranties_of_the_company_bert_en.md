...
date: 2022-12-16
tags: [en, legal, clauses, classification, licensed, bert, representations, and, warranties, of, the, company, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_representations_and_warranties_of_the_company_bert_en_1.0.0_3.0_1671227649598.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_representations_and_warranties_of_the_company_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_representations_and_warranties_of_the_company_bert|
